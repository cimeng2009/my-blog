...
export const ja: Translation = {
	...
	[Key.navPosts]: "記事",
	[Key.bookshelf]: "本棚",
	[Key.moviesGames]: "映画とゲーム",
	[Key.musicPage]: "音楽",
	[Key.changelog]: "更新履歴",
	[Key.moments]: "動き",
	[Key.routines]: "日常計画",
	[Key.places]: "旅行の足跡",
	[Key.notebooks]: "ノートブック",
	[Key.adminPanel]: "管理パネル",
	...
	[Key.changelogSubtitle]: "すべての改善を記録する",
	[Key.changelogAll]: "すべて",
	[Key.changelogFeature]: "機能",
	[Key.changelogImprovement]: "改善",
	[Key.changelogFix]: "修正",
	[Key.changelogRemoval]: "削除",
	[Key.changelogNoData]: "更新履歴はありません",
	[Key.categoryList]: "カテゴリ一覧",
	[Key.categoryPosts]: "カテゴリ記事",
	[Key.allCategories]: "すべてのカテゴリ",
	[Key.recentMoments]: "最近の動き",
	[Key.portalRecentPosts]: "最近の記事",
	[Key.portalRecentMoments]: "最近の動き",
	[Key.portalViewAll]: "すべて表示",
	[Key.portalViewMore]: "もっと見る",
	[Key.portalRunningDays]: "運用中",
	[Key.portalDays]: "日",
	[Key.recentLife]: "最近の生活",
	[Key.recentItems]: "最近の項目",
	[Key.booksTitle]: "本棚",
	[Key.booksSubtitle]: "読んだ本を記録する",
	[Key.bookshelfReading]: "読んでいる",
	[Key.bookshelfRead]: "読んだ",
	[Key.bookshelfWantRead]: "読みたい",
	[Key.booksNoData]: "本はありません",
	[Key.moviesGamesTitle]: "映画とゲーム",
	[Key.moviesGamesSubtitle]: "見た作品を記録する",
	[Key.moviesGamesTabAll]: "すべて",
	...
	[Key.moviesGamesNoData]: "データはありません",
	[Key.musicPageTitle]: "音楽",
	[Key.musicPageSubtitle]: "音楽の美しさを楽しむ",
	[Key.musicPageNoData]: "音楽はありません",
	[Key.siteHeatmap]: "サイトヒートマップ",
	[Key.welcomeCardLocation]: "現在の場所",
	[Key.welcomeCardGreeting]: "こんにちは",
	[Key.welcomeCardRecentUpdates]: "最近の更新",
	[Key.welcomeCardFlipHint]: "クリックして反転",
	[Key.welcomeCardDragHint]: "ドラッグして移動",
	[Key.welcomeCardClose]: "閉じる",
	[Key.welcomeCardLearnMore]: "詳細を見る",
