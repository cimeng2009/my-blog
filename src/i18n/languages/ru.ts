...
export const ru: Translation = {
	...
	[Key.navPosts]: "Статьи",
	[Key.bookshelf]: "Книжная полка",
	[Key.moviesGames]: "Фильмы и игры",
	[Key.musicPage]: "Музыка",
	[Key.changelog]: "Журнал изменений",
	[Key.moments]: "Моменты",
	[Key.routines]: "Ежедневные дела",
	[Key.places]: "Места посещения",
	[Key.notebooks]: "Блокнот",
	[Key.adminPanel]: "Панель админа",
	...
	[Key.changelogSubtitle]: "Запись каждого улучшения",
	[Key.changelogAll]: "Все",
	[Key.changelogFeature]: "Функции",
	[Key.changelogImprovement]: "Улучшения",
	[Key.changelogFix]: "Исправления",
	[Key.changelogRemoval]: "Удаления",
	[Key.changelogNoData]: "Нет изменений",
	[Key.categoryList]: "Список категорий",
	[Key.categoryPosts]: "Статьи категории",
	[Key.allCategories]: "Все категории",
	[Key.recentMoments]: "Недавние моменты",
	[Key.portalRecentPosts]: "Недавние статьи",
	[Key.portalRecentMoments]: "Недавние моменты",
	[Key.portalViewAll]: "Просмотреть все",
	[Key.portalViewMore]: "Просмотреть больше",
	[Key.portalRunningDays]: "Работает",
	[Key.portalDays]: "дней",
	[Key.recentLife]: "Недавняя жизнь",
	[Key.recentItems]: "Недавние элементы",
	[Key.booksTitle]: "Книжная полка",
	[Key.booksSubtitle]: "Запись прочитанных книг",
	[Key.bookshelfReading]: "Читаю",
	[Key.bookshelfRead]: "Прочитано",
	[Key.bookshelfWantRead]: "Хочу прочитать",
	[Key.booksNoData]: "Нет книг",
	[Key.moviesGamesTitle]: "Фильмы и игры",
	[Key.moviesGamesSubtitle]: "Запись просмотренных работ",
	[Key.moviesGamesTabAll]: "Все",
	[Key.moviesGamesTabMovie]: "Фильм",
	[Key.moviesGamesTabTV]: "ТВ",
	[Key.moviesGamesTabAnime]: "Аниме",
	[Key.moviesGamesTabDocumentary]: "Документальный",
	[Key.moviesGamesTabGame]: "Игра",
	[Key.moviesGamesNoData]: "Нет данных",
	[Key.musicPageTitle]: "Музыка",
	[Key.musicPageSubtitle]: "Наслаждаться красотой музыки",
	[Key.musicPageNoData]: "Нет музыки",
	[Key.siteHeatmap]: "Тепловая карта сайта",
	[Key.welcomeCardLocation]: "Текущее местоположение",
	[Key.welcomeCardGreeting]: "Привет",
	[Key.welcomeCardRecentUpdates]: "Недавние обновления",
	[Key.welcomeCardFlipHint]: "Нажмите для переворота",
	[Key.welcomeCardDragHint]: "Перетащите для перемещения",
	[Key.welcomeCardClose]: "Закрыть",
	[Key.welcomeCardLearnMore]: "Узнать больше",
	[Key.welcomeCardRecentLabel]: "Последнее",
